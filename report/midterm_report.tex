...
\title{\textbf{Project Report: Qwen Fine-Tuning for CS/AI Paper Translation}}
\author{Jiale Lin, Liuchang Chen}
\date{May 24, 2026}
...
\begin{table}[htbp]
    ...
    \resizebox{\textwidth}{!}{\input{tables/dataset_summary.tex}}
\end{table}
...
\begin{table}[htbp]
    ...
    \resizebox{\textwidth}{!}{\input{tables/training_summary.tex}}
\end{table}
...
\begin{table}[htbp]
    ...
    \input{tables/stage2_collection.tex}
\end{table}

Figure~\ref{fig:stage2-years} shows the accepted-paper year distribution. The pool is concentrated in 2020--2022.
...
Figure~\ref{fig:stage2-categories} shows the top OpenAlex topics. The pool includes relevant AI topics such as NLP, multimodal learning, domain adaptation, and adversarial robustness, and it also contains many quantum-computing and quantum-information papers.
...
Useful baselines are base Qwen3-4B, the single-stage Qwen3-4B SFT checkpoint, the saved Qwen3-32B on a small diagnostic subset, and teacher outputs.
