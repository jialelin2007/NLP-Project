...
output_dir: runs/checkpoints/stage1_smoke
max_seq_length: 4096
max_steps: 5
...
train_file: data/processed/stage1/sft/tiny_train.jsonl
validation_file: data/processed/stage1/sft/validation.jsonl
output_dir: runs/checkpoints/qwen3_32b_stage1_smoke
logging_dir: runs/logs/qwen3_32b_stage1_smoke
...
""",
    ...
    assert config.logging_dir == Path("runs/logs/qwen3_32b_stage1_smoke")
