...
from nlp_project.evaluation import compute_sacrebleu, make_sample_record, write_json  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("outputs/eval/copy_source_baseline")
    )
